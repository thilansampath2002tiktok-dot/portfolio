          ...
          <table className="w-full text-left border-collapse">
            ...
            <tbody>
              {services.map((service) => (
                <tr key={service._id} className="border-b border-gray-800 hover:bg-gray-800/50 transition-colors">
                  <td className="p-4">
                  ...
                  <td className="p-4 flex justify-end space-x-2">
                    ...
                    <button onClick={() => handleDelete(service._id)} title="Delete service" aria-label="Delete service" className="p-2 text-gray-400 hover:text-red-400 transition-colors bg-gray-800 rounded-lg shrink-0">
